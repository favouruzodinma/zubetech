        ...
        <footer class="s-footer">
            <div class="row s-footer__content">
                <div class="column xl-6 lg-6 md-12 s-footer__block s-footer__about">                    
                    <h3>About Zubetech</h3>
                    <p>
                    Our passion for technology and our expertise in harnessing the plethora
                   of ways by which it can transform a business has enabled us to deliver incredible customer experiences.
                    </p>               
                </div>                
            ...
            <div class="row s-footer__bottom">
                ...
                <div class="column xl-6 lg-12">
                    <p class="ss-copyright">
                        <span>© Copyright Zubetech  <script>
                                     document.write(new Date().getFullYear())
                                   </script></span> 
                        <span>Design by <a href="https://zubetec.com/">Zubetech</a></span>
                    </p>
                </div>
